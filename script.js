...
let Y=Math.floor(19*Math.random())
let snakeArr=[
    {x:X,y:Y}
];
let food={x:Math.floor(19*Math.random()),y:Math.floor(19*Math.random())};
...
const gameEngine=()=>{
    musicSound.play();
//part1:updating the food and snake
...
if (snakeArr[0].x===food.x && snakeArr[0].y===food.y){
    ...
    food={x:Math.floor(19*Math.random()),y:Math.floor(19*Math.random())};
    foodSound.play();
    score++;
